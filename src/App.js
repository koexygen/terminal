                                ...
                                <div className="column-child sidebar shadow">
                                    <div className="sidebar-header has-text-centered">
                                        ...
                                        <div className="social-icons">
                                            <a href="https://www.facebook.com/gg.chomakhashvili"><i
                                                className="fab fa-facebook icon"/></a>
                                            <a href="https://github.com/koexygen"><i
                                                className="fab fa-github icon"/></a>
                                            <a href="https://www.instagram.com/koexygen/"><i
                                                className="fab fa-instagram icon"/></a>
                                            <a href='https://wa.me/995558888884'><i
                                                className="fab fa-whatsapp icon"/></a>
                                        </div>
                                        <div className="resume">
                                            <a href="https://gtmetrix.com/reports/gioc.info/OgPIboTE"
                                               className="sidebar-link" target='_blank'>
                                                GT Metrix Score
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div className="column is-flex">
                                <div className="column-child terminal shadow">
                                    <div className="terminal-bar dark-mode">
                                        ...
                                        <div className="terminal-bar-text is-hidden-mobile dark-mode-text">guest@gio:
                                            ~
                                        </div>
                                    </div>
                              ...
                              <span className="help-msg">Welcome to Gio's Terminal — Type <span
                                  className="code">help </span>
                        and hit "Enter" or "Return" for a list of supported commands.</span>
                                            </div>
                                        </div>
                                        <div className="terminal-line">
                                            <span className="success">➜</span> <span className="directory">~</span>
